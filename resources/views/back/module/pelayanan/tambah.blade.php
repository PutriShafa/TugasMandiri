...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-7 align-self-center">
            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Tambah Pelayanan</h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item text-muted active" aria-current="page">Tambah Pelayanan</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ URL::to('tambah_pelayanan') }}">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" name="produk_pelayanan" placeholder="Masukkan Produk Pelayanan" required>
                                <br>
                            </div>
                            <div class="col-md-6">
                                <label>Jangka Waktu</label>
                                <input class="form-control" name="jangka_waktu" placeholder="Masukkan Jangka Waktu" required>
                                <br>
                            </div>
                            <div class="col-md-6">
                                <label>Biaya / Tarif</label>
                                <input class="form-control" name="tarif" placeholder="Masukkan Biaya / Tarif" required>
                                <br>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="tinymce-wrap">
                                    <textarea class="tinymce" name="persyaratan"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label>Sistem Mekanisme dan Prosedur</label>
                                <div class="tinymce-wrap">
                                    <textarea class="tinymce" name="prosedur"></textarea>
                                </div>
                                <br>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="tinymce-wrap">
                                    <textarea class="tinymce" name="dasar_hukum"></textarea>
                                </div>
                            </div>
                        </div>
                        <br>
