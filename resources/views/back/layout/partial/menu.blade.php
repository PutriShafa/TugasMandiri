            ...
            <div class="navbar-brand">
                <center>
                    <a href="{{ URL::to('/') }}">
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
                            <img src="{{ URL::asset('back/assets/images/favicon.png') }}" alt="homepage"
                                class="dark-logo" width="100%" style="max-width: 150px; margin-top: 10px;" />
                            <!-- Light Logo icon -->
                            <img src="{{ URL::asset('back/assets/images/favicon.png') }}" alt="homepage"
                                class="light-logo" width="100%" style="max-width: 150px; margin-top: 10px;" />
                        </b>
                    </a>
                </center>
            </div>
            ...
            <ul class="navbar-nav float-right">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        ...
                        <a class="dropdown-item" href="{{ URL::to('logout') }}"><i data-feather="power"
                                class="svg-icon mr-2 ml-1"></i>
                            Logout
                        </a>
                    </div>
...
<aside class="left-sidebar" data-sidebarbg="skin6">
    ...
    echo 'selected';
                ...
                @if ($user->id_profile == '3')
                    <li class="sidebar-item <?php if ($title == 'Antrian') {
    echo 'selected';
} ?>">
                ...
                @endif
                @if ($user->id_profile == '1' || $user->id_profile == '2')
                    <li class="sidebar-item <?php if ($title == 'User') {
    echo 'selected';
} ?>">
