...
<head>
    ...
    <link href="{{ URL::asset('public/front/sweetalert2/dist/sweetalert2.min.css') }}" rel="stylesheet">
</head>
...
<body>
    ...
    <script src="{{ URL::asset('public/front/sweetalert2/dist/sweetalert2.min.js') }}"></script>
