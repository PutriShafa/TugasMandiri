...
<body>
    ...
    <section class="banner-2 bg_img" data-background="{{ URL::asset('public/front/assets/images/banner/banner-2.jpg') }}" style="margin-top: -50px; height: 650px;">
        <div class="container">
        ...
        $.ajax({
            ...
            success : function(data){
                ...
                if (no_antrian != data[0] && data[0] != undefined) {
                    ...
                    var loket = data[1];
                    console.log(loket);
                    responsiveVoice.speak("Nomor antrian"+data[0]+" segera ke "+loket,"Indonesian Female",{
                        pitch: 0, 
                        rate: 1, 
                        volume: 2
                    });
